...
<script>
	...
	$("#order").change(function(){
		...
		if($("#order").val()=='pop'){
				...
				location.href="<%=request.getContextPath()%>/selectProListPop.pro?cid=<%=cid%>";
			
				
		
		}else if($("#order").val()=='low'){
			    location.href="<%=request.getContextPath()%>/selectProListLow.pro?=<%=cid%>";
		}else if($("#order").val()=='new'){
				location.href="<%=request.getContextPath()%>/selectProListNew.pro?=<%=cid%>";
		}else if($("#order").val()=='high'){
				location.href="<%=request.getContextPath()%>/selectProListHigh.pro?=<%=cid%>";
		}
