				...
				<section id="contents">
					...
					<div class="manageButton">
						<table style="height:100%;">
							<tr align="center">
								<td width="150px;min-width:150px;">교환 처리</td>
								<td><button style="width:120px;">교환 전 처리</button></td>
								<td><button style="width:120px;">교환 중 처리</button></td>
								<td><button style="width:120px;">교환 완료 처리</button></td>
								<td><button style="width:120px;">교환 거절 처리</button></td>
							</tr>
						</table>
					</div>
