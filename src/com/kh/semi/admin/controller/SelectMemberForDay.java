...
/**
 * Servlet implementation class SelectMemberForDay
 */
@WebServlet("/selectMemberForDay.ad")
public class SelectMemberForDay extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
 
    public SelectMemberForDay() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Map<String, ArrayList> hmap = new adminService().selectMemberForDay(sDate, eDate, date);
		ArrayList<String> list2 = new adminService().getDay(sDate, eDate, choice);
