...
public class adminRefundServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int listCount = new adminService().exchangeListCount(memberId);
		...
		ArrayList<HashMap<String, Object>> list = new adminService().selectExchangeList(pi, memberId);
		
		String page = "";
		if(list != null) {
			page="views/admin/adminSaleExchange.jsp";
