...
/**
 * Servlet implementation class InsertFundReviewServlet
 */
@WebServlet("/insertFundReview.bo")
public class InsertFundReviewServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public InsertFundReviewServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Review> reviewList = new FundReviewService().insertReviewList(rv);
