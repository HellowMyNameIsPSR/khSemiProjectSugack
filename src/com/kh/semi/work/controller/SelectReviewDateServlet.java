...
@WebServlet("/selectReviewDate.wo")
public class SelectReviewDateServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public SelectReviewDateServlet() {}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int listCount = new WorkService().reviewDateCount(memberId, wrDate1, wrDate2);
		...
		ArrayList<HashMap<String, Object>> list = new WorkService().selectReviewDate(pi, memberId, wrDate1, wrDate2);
