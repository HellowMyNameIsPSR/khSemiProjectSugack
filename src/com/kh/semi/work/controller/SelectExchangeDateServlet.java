...
@WebServlet("/selectExchangeDate.wo")
public class SelectExchangeDateServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public SelectExchangeDateServlet() {}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int listCount = new WorkService().exchangeDateCount(memberId, wrDate1, wrDate2);
