...
@WebServlet("/selectPostDate.wo")
public class SelectQnaDateServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public SelectQnaDateServlet() {}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int listCount = new WorkService().qnaDateCount(memberId, wrDate1, wrDate2);
		...
		ArrayList<HashMap<String, Object>> list = new WorkService().selectQnaDate(pi, memberId, wrDate1, wrDate2);
