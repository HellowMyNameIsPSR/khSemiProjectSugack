...
/**
 * Servlet implementation class SelectSalesForMainFund
 */
@WebServlet("/selectSalesForMainFund.at")
public class SelectSalesForMainFund extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SelectSalesForMainFund() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<HashMap<String, Object>> list = new AuthorService().selectSalesForMainFund(mid);
